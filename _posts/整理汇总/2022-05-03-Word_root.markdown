...
1. al/ali/alter/ulter：其他的，改变状态 alter(alternate) altercate adulterate altruist allegory allergy alias alien(inalienable)
1. ali：营养 aliment
...
1. cervic：颈 cervical
1. cess：走 access(accessory) process(procession) recess(recession) success(succession) concession
1. cest：走 ancestor
...
1. foss：挖 fossil
1. found：创立 profound
1. fract：打破 fracture fraction anfractuous
...
1. lay：放置 relay
1. lax/leas/lang：松，疲倦 lax relax delay lease(lessor lessee) languid
1. lapid：石头 lapidate(lapidary delapidate)
1. lect：讲 lecture dialect
1. lect：选择，收集 select collect intellectual neglect
1. leg：法律 legislation legistimate delegate(delegacy)
